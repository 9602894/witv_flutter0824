...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  // FocusNode for TV remote navigation
  ...
  void initState() {
    ...
    _nameFocus = _createTvFocusNode();
    _urlFocus = _createTvFocusNode();
    _addBtnFocus = _createTvFocusNode();
    _epgUrlFocus = _createTvFocusNode();
    _epgSaveBtnFocus = _createTvFocusNode();
    _tokenFocus = _createTvFocusNode();
    _tokenSaveBtnFocus = _createTvFocusNode();
    _logoSourceFocus = _createTvFocusNode();
    _clearLogoFocus = _createTvFocusNode();
    _decoderFocus = _createTvFocusNode();
    _autoReconnectFocus = _createTvFocusNode();
    _exportLogFocus = _createTvFocusNode();
    _clearLogFocus = _createTvFocusNode();
  }
    ...
    return FocusNode(
      onKey: (node, event) {
        ...
        if (key == LogicalKeyboardKey.arrowLeft || key == LogicalKeyboardKey.arrowRight) {
          // For TextFields, allow left/right to move cursor unless at boundary
          // For other widgets, move focus horizontally if possible
          if (node.context?.widget is TextField) {
            final controller = _getControllerForFocus(node);
            if (controller != null) {
              final selection = controller.selection;
              if (key == LogicalKeyboardKey.arrowLeft && selection.baseOffset > 0) {
                return KeyEventResult.ignored;
              }
              if (key == LogicalKeyboardKey.arrowRight && selection.baseOffset < controller.text.length) {
                return KeyEventResult.ignored;
              }
            }
          }
          // Try to move focus to nearby node
  ...
  TextEditingController? _getControllerForFocus(FocusNode node) {
    if (node == _nameFocus) return _nameController;
    if (node == _urlFocus) return _urlController;
    if (node == _epgUrlFocus) return _epgUrlController;
    if (node == _tokenFocus) return _tokenController;
    return null;
  }
